...
for i in range(len(a)):
    print('<line x1="0" y1="%s" x2="1440" y2="%s" style="stroke:rgb(220,220,220);stroke-width:1"/>' %
          (a[i], a[i]))

for i in range(24):
    print('<line x1="%d" y1="0" x2="%d" y2="3000" style="stroke:rgb(128,128,128);stroke-width:1"/>' % (i*60, i*60))
    print('<line x1="%d" y1="0" x2="%d" y2="3000" style="stroke:rgb(220,220,220);stroke-width:1"/>' %
          (i*60+30, i*60+30))
